...
@onready var relic_2_silhouette = $MarginContainer/HBoxContainer/CenterContainer
@onready var relic_2 = $MarginContainer/HBoxContainer/Relic2
@onready var relic_3_silhouette = $MarginContainer/HBoxContainer/CenterContainer
@onready var relic_3 = $MarginContainer/HBoxContainer/Relic3
@onready var relic_4_silhouette = $MarginContainer/HBoxContainer/CenterContainer
@onready var relic_4 = $MarginContainer/HBoxContainer/Relic4
@onready var relic_5_silhouette = $MarginContainer/HBoxContainer/CenterContainer
